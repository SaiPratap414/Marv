...
const Header: FunctionComponent<HeaderType> = ({ className = "" }) => {
  ...
  return (
    <section style={{width:"100%",height:"100vh",maxHeight:"800px",minHeight:"750px",display:"flex",gap:"10%",flexDirection:"column",justifyContent:"center",alignItems:"center"}} className={[styles.header, className].join(" ")} id="header">
      <div></div>
