    ...
    <section className={[styles.mainwrapper, className].join(" ")} id="header">
      <div className={[styles.subwrapper, className].join(" ")}>
        ...
        <div className={[styles.body, className].join(" ")}>
          ...
          <Framecontainer className={className} color="linear-gradient(#F9B889, #926546)" image="/buy1-1@2x.png" title="Secure your" subTitle="you can buy ​$sol from any ​exchange and ​even on ​phantom ​wallet"></Framecontainer>
          <Framecontainer className={className} color="linear-gradient(#58A098, #69C6BA)" image="/buy1-1@2x.png" title="Buy some $Marv" subTitle="Now go to ​Raydium and paste ​the $MARV ​Contract Address ​to swap your SOL."></Framecontainer>
          <Framecontainer className={className} color="linear-gradient(#AC9CDB, #7462A6)" image="/buy1-1@2x.png" title="Add to Your Wallet" subTitle="Now you’re all set! ​Welcome aboard the ​next rocket to the ​moon, just import the ​contract address to ​view you’re holdings ​and you can track ​your earnings."></Framecontainer>
        </div>
      </div>
    </section>
  );
